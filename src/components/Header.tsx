...
export default function Header() {
    return (
        <header className="h-screen flex flex-col justify-center align-baseline">
            <WavyBackground className="">
                <div className="mx-auto flex flex-col items-center w-fit z-10 text-center text-white">
            ...
            <a href="#projects" className="self-center absolute bottom-6">
                <svg
    ...
    return (
        <header className="w-full h-screen flex flex-col justify-center align-baseline">
            ...
            <svg
                className="animate-bounce w-10 h-10 self-center absolute bottom-5"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 14 8"
