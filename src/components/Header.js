...
function CustomButton({text, type}) {
    const primaryStyle =
        "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 :bg-blue-600 focus:outline-none grow cursor-pointer";
    const secondaryStyle =
        "py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 grow cursor-pointer";
    const tertiaryStyle = "";
